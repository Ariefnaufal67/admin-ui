    ...
    <>
      <div className="p-6 grid grid-cols-1 md:grid-cols-3 gap-6">
        {courses.map((course, index) => (
          <div key={index} className="shadow rounded-lg overflow-hidden flex flex-col hover:border hover:border-gray-500 hover:shadow-lg 
          ...
          {/* Content */}
            <div className="p-4 bg-red-100 flex flex-col justify-between">
              <h3 className="text-lg font-semibold mb-4">{course.title}</h3>

              	<div className="bg-red-50 p-2 rounded-lg">
                <div className="text-sm text-gray-500 mt-2 flex justify-between h-full">
                  <span>👥 123 users</span>
                  <span>⏱ 60 mins</span>
                </div>
